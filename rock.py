...
def play():
    ...
    if is_win(user, computer):
        return "You have chosen {} and the computerhas chosen {}. You won!!!".format(user, computer)

    return "You have chosen {} and the computerhas chosen {}. You lost!!!".format(user, computer)
